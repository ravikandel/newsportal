...
$myItem = getSubCategoryInfo($SubCatId);
...
<head>
  ...
  <title> <?php echo htmlentities($myItem['SubCategoryName']); ?> | News Portal</title>
...
<body class="light__theme" id="kbpatra-body">
 ...
 <?php include('includes/adv2.php'); ?>
  ...
  $sql = 'SELECT COUNT(*) FROM tblposts WHERE CategoryId =' . $CatId . ' AND SubCategoryId =' . $SubCatId . ' AND IsActive=1';
      ...
      <div class="row">
        <div class="col* col-xs-12  col-sm-12 col-md-12 col-lg-12 col-xl-9">
          <div class="section-title mb-3">
            <h3><a class="section-title-link px-3" href="category.php?id=<?php echo htmlentities($myItem['SubCategoryId']); ?>"><i class="ri-equalizer-line"></i> <?php echo htmlentities($myItem['SubCategoryName']); ?></a>
          ...
          <div id="news" class="row">
            <?php
            getPostsBySubCategory($CatId, $SubCatId, $offset, $no_of_records_per_page); ?>
          </div>
          <?php if ($total_rows > $no_of_records_per_page) { ?>
            <div class="container-fluid text-center py-3">
              <ul class="pagination pagination-lg justify-content-center">
                <li class="page-item"><a href="?id=<?php echo $Id; ?>&pageno=1" class="page-link">First</a></li>
                ...
                <li class="page-item"><a href="?id=<?php echo $Id; ?>&pageno=<?php echo $total_pages; ?>" class="page-link">Last</a></li>
              </ul>
            </div>
          <?php } ?>
