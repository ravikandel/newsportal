...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
     ...
     try{
            $sql = "SELECT Id FROM tbladmin WHERE AdminUserName=? AND AdminEmailId=?";
            ...
            if ($result) {
                ...
                $mysql = "update tbladmin set AdminPassword=? where AdminUserName=? AND AdminEmailId=?";
                $con->prepare($mysql)->execute([$password,$username,$email]);
