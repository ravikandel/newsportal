    ...
    if (isset($_POST['update'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $postid = intval($_GET['pid']);
             try
            {
                $sql = "update tblposts set PostImage=? where id=?";
                $con->prepare($sql)->execute([$imgnewfile,$postid]);
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Change Image | Newsportal</title>
                    ...
                    <div class="container">
                        ...
                        <form name="addpost" method="post" enctype="multipart/form-data">
                            ...
                            try
                            {
                                ...
                                $sqls = "select PostImage,PostTitle from tblposts where id=? AND IsActive=1"; 
