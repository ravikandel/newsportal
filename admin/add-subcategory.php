...
error_reporting(0);
    ...
    if (isset($_POST['submitsubcat'])) {
        ...
        $status = 1;
           ...
           try 
        {
            $sql = "INSERT INTO tblsubcategory(CategoryId,SubCategoryName,SubCategoryDescription,IsActive) values(?,?,?,?)";
            $con->prepare($sql)->execute([$categoryid, $subcatname,$subcatdescription, $status]);
            
            $msg = "Sub-Category created succesfully";
        } 
...
?>
    ...
    <head>
        ...
        <title>Add Sub Category | Newsportal</title>
