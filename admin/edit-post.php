...
error_reporting(0);
    ...
    if (isset($_POST['update'])) {
        $posttitle = preg_replace('/[^A-Za-z0-9 ]/', '', $_POST['posttitle']);
        ...
        $postid = intval($_GET['pid']);
         ...
         try
        {
            $sql = "update tblposts set PostTitle=?,CategoryId=?,SubCategoryId=?,PostDetails=?,PostUrl=?,IsActive=?,lastUpdatedBy=? where id=?";
            $con->prepare($sql)->execute([$posttitle,$catid,$subcatid,$postdetails,$url,$status,$lastuptdby,$postid]);
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Edit Post | Newsportal</title>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    try
                                    {
                                        ...
                                        $sql = "Select tblposts.id as postid,tblposts.PostImage,tblposts.PostTitle as title,tblposts.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.SubcategoryName as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id=? and tblposts.IsActive=1"; 
