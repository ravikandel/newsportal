                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-settings"></i> <span> Theme Setting </span> <span class="menu-arrow"></span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="theme-setting.php">General Setup</a></li>
                                        <li><a href="add-adv.php">Add Advertisement</a></li>
                                        <li><a href="manage-adv.php">Manage Advertisement</a></li>
                                    </ul>
                                </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="trash-categories.php">Trash Category</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="trash-subcategories.php">Trash Sub-Category</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
