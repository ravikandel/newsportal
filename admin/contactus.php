...
if(isset($_POST['update']))
{
 ...
 try
 {
        $sql = "UPDATE tblpages SET PageTitle=?,Description=? WHERE PageName=?";
        $con->prepare($sql)->execute([$pagetitle,$pagedetails,$pagetype]);
...
<?php } ?>
 ...
 <?php 
        ...
        {
            $pagetype="contactus";
            $sql = "Select PageTitle,Description FROM tblpages WHERE PageName=?"; 
